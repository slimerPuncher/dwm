...
static const char *fonts[]          = { "Source Code Pro:size=12", "Font Awesome 5 Free:size=12", "Noto Sans Mono:size=12" };
...
static const char col_cyan[]        = "#128759";        /*005577*/
...
/* brightness */
static const char *upbright[] = {"brightnessctl", "set", "2%+", NULL };
static const char *downbright[] = {"brightnessctl", "set", "2%-", NULL };
